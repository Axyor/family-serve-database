...
This section provides instructions for developers who want to contribute to this project.
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/Axyor/family-serve-delicious.git
...
This project uses Jest for testing and Docker to run an isolated MongoDB instance, ensuring a clean and consistent test environment.

**Run all tests:**

The recommended way to run tests is using the all-in-one command, which starts the database, runs the tests, and cleans up afterward.
...
For more control during development, you can run the commands separately.
...
Tests use a dedicated database named `family-serve-test`, which is automatically seeded with test data.
...
-   **Commits:** We use [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) for our commit messages. This allows for automated changelog generation.
-   **Pull Requests:** Open a pull request to the `main` branch. Please provide a clear description of your changes.
